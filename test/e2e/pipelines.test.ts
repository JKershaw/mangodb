...
describe(`Complex Pipeline Scenarios (${getTestModeName()})`, () => {
  ...
  describe("E-commerce Analytics", () => {
    it("should calculate sales summary by category with filtering", async () => {
      ...
      await collection.insertMany([
        { product: "Laptop", category: "Electronics", price: 1000, qty: 2, date: new Date("2023-06-15") },
        { product: "Phone", category: "Electronics", price: 500, qty: 5, date: new Date("2023-06-16") },
        { product: "Shirt", category: "Clothing", price: 30, qty: 10, date: new Date("2023-06-15") },
        { product: "Pants", category: "Clothing", price: 50, qty: 8, date: new Date("2023-06-16") },
        { product: "Tablet", category: "Electronics", price: 300, qty: 3, date: new Date("2023-06-17") },
      ]);
  ...
  describe("Statistical Analysis", () => {
    ...
    it("should bucket data into ranges", async () => {
      ...
      await collection.insertMany([
        { score: 15 }, { score: 25 }, { score: 35 },
        { score: 45 }, { score: 55 }, { score: 65 },

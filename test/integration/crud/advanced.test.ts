...
describe(`Advanced Operations Tests (${getTestModeName()})`, () => {
  ...
  describe('findOneAndDelete', () => {
    ...
    it('should sort by array field using minimum element (ascending)', async () => {
      ...
      const result = await collection.findOneAndDelete({}, { sort: { scores: 1 } });
    ...
    it('should sort by boolean field correctly', async () => {
      ...
      const result = await collection.findOneAndDelete({}, { sort: { active: 1 } });
  ...
  describe('findOneAndReplace', () => {
    ...
    it('should preserve _id when replacing', async () => {
      ...
      await collection.findOneAndReplace({ name: 'Alice' }, { name: 'Bob', newField: true });
    ...
    it('should return null when no match', async () => {
      ...
      const result = await collection.findOneAndReplace({ name: 'Nobody' }, { name: 'Bob' });
    ...
    it('should reject replacement containing update operators', async () => {
      ...
      await assert.rejects(
        collection.findOneAndReplace({ name: 'Alice' }, { $set: { age: 30 } } as unknown as Record<
          string,
          unknown
        >),
  ...
  describe('findOneAndUpdate', () => {
    ...
    it('should return null when no match', async () => {
      ...
      const result = await collection.findOneAndUpdate({ name: 'Nobody' }, { $set: { age: 25 } });
  ...
  describe('bulkWrite', () => {
    ...
    describe('deleteOne operations', () => {
      it('should delete a single document', async () => {
        ...
        const result = await collection.bulkWrite([{ deleteOne: { filter: { x: 1 } } }]);
    ...
    describe('deleteMany operations', () => {
      it('should delete multiple documents', async () => {
        ...
        const result = await collection.bulkWrite([{ deleteMany: { filter: { x: 1 } } }]);

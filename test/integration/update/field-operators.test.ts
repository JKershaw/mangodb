...
describe(`Update Operation Tests (${getTestModeName()})`, () => {
  ...
  describe('updateOne', () => {
    describe('basic update with $set', () => {
      ...
      it('should only update the first matching document', async () => {
        ...
        await collection.updateOne({ type: 'fruit' }, { $set: { updated: true } });
      ...
      it('should return matchedCount 0 when no match', async () => {
        ...
        const result = await collection.updateOne({ name: 'Bob' }, { $set: { age: 25 } });
      ...
      it('should set multiple fields at once', async () => {
        ...
        await collection.updateOne({ name: 'Alice' }, { $set: { age: 30, city: 'NYC' } });
      ...
      it('should create new fields with $set', async () => {
        ...
        await collection.updateOne({ name: 'Alice' }, { $set: { newField: 'value' } });
    ...
    describe('$set with dot notation (nested fields)', () => {
      it('should update nested fields', async () => {
        ...
        await collection.updateOne({ name: 'Alice' }, { $set: { 'address.city': 'LA' } });
      ...
      it("should create nested structure when path doesn't exist", async () => {
        const collection = client.db(dbName).collection('update_set_nested_create');
        await collection.insertOne({ name: 'Alice' });

        await collection.updateOne({ name: 'Alice' }, { $set: { 'a.b.c': 'deep' } });

        const doc = await collection.findOne({ name: 'Alice' });
        assert.strictEqual((doc?.a as { b: { c: string } }).b.c, 'deep');
      });
    ...
    describe('$unset operator', () => {
      ...
      it('should remove nested field', async () => {
        ...
        await collection.updateOne({ name: 'Alice' }, { $unset: { 'address.zip': '' } });

        const doc = await collection.findOne({ name: 'Alice' });
        assert.strictEqual((doc?.address as { city: string }).city, 'NYC');
        assert.strictEqual((doc?.address as { zip?: string }).zip, undefined);
      });
    ...
    describe('$inc operator', () => {
      ...
      it('should increment nested field', async () => {
        ...
        await collection.updateOne({ name: 'Alice' }, { $inc: { 'stats.score': 5 } });
  ...
  describe('updateMany', () => {
    it('should update all matching documents', async () => {
      ...
      const result = await collection.updateMany({ type: 'fruit' }, { $set: { organic: true } });
    ...
    it('should return zero counts when no match', async () => {
      ...
      const result = await collection.updateMany({ name: 'Nobody' }, { $set: { age: 25 } });
  ...
  describe('upsert option', () => {
    ...
    it('should apply $inc in upserted document', async () => {
      ...
      await collection.updateOne({ name: 'counter' }, { $inc: { value: 5 } }, { upsert: true });
  ...
  describe('modifiedCount behavior', () => {
    it('should not count as modified if values are the same', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $set: { age: 30 } });
  ...
  describe('edge cases', () => {
    ...
    it('should handle array values in $set', async () => {
      ...
      await collection.updateOne({ name: 'Alice' }, { $set: { tags: ['a', 'b', 'c'] } });
    ...
    it('should preserve nested arrays when updating other fields', async () => {
      ...
      await collection.updateOne({ name: 'test' }, { $set: { updated: true } });
...
describe(`Additional Update Operators (${getTestModeName()})`, () => {
  ...
  describe('$min operator', () => {
    ...
    it('should not update when new value is greater than current', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $min: { lowScore: 100 } });
    ...
    it('should not update when values are equal', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $min: { score: 75 } });
    ...
    it('should work with nested fields using dot notation', async () => {
      ...
      await collection.updateOne({ name: 'Alice' }, { $min: { 'stats.lowScore': 50 } });
    ...
    it('should work with dates', async () => {
      ...
      const doc = await collection.findOne({ name: 'Alice' });
      assert.strictEqual((doc?.firstVisit as Date).getTime(), earlier.getTime());
    });
    ...
    it('should not update date when new date is later', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $min: { firstVisit: later } });
  ...
  describe('$max operator', () => {
    ...
    it('should not update when new value is less than current', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $max: { highScore: 50 } });
    ...
    it('should not update when values are equal', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $max: { score: 75 } });
    ...
    it('should work with nested fields', async () => {
      ...
      await collection.updateOne({ name: 'Alice' }, { $max: { 'stats.highScore': 100 } });
  ...
  describe('$mul operator', () => {
    ...
    it('should work with nested fields', async () => {
      ...
      const doc = await collection.findOne({});
      assert.strictEqual((doc?.stats as { multiplier: number }).multiplier, 15);
    });
  ...
  describe('$rename operator', () => {
    ...
    it('should work with nested source field using dot notation', async () => {
      ...
      const doc = await collection.findOne({ name: 'Alice' });
      assert.strictEqual((doc?.data as { newName: string; oldName?: string }).newName, 'value');
      assert.strictEqual((doc?.data as { newName: string; oldName?: string }).oldName, undefined);
    });
    ...
    it('should move field to different nesting level', async () => {
      ...
      await collection.updateOne({ name: 'Alice' }, { $rename: { 'nested.field': 'topLevel' } });

      const doc = await collection.findOne({ name: 'Alice' });
      assert.strictEqual(doc?.topLevel, 'value');
      assert.strictEqual((doc?.nested as { field?: string }).field, undefined);
    });
  ...
  describe('$currentDate operator', () => {
    ...
    it('should set field to timestamp with $type: timestamp', async () => {
      const collection = client.db(dbName).collection('currentdate_type_timestamp');
      await collection.insertOne({ name: 'Alice' });
    ...
    it('should work with nested fields', async () => {
      ...
      await collection.updateOne({ name: 'Alice' }, { $currentDate: { 'meta.updatedAt': true } });
  ...
  describe('$setOnInsert operator', () => {
    ...
    it('should only apply $setOnInsert on second upsert when doc exists', async () => {
      ...
      assert.strictEqual((doc?.createdAt as Date).getTime(), initialDate.getTime());
    });
  });
  ...
  describe('edge cases and error conditions', () => {
    it('$rename should throw error when source equals destination', async () => {
      ...
      await assert.rejects(
        async () => await collection.updateOne({}, { $rename: { field: 'field' } }),
        (err: Error) => {
          return err.message.includes('source and dest') || err.message.includes('must differ');
        }
      );
    });
    ...
    it('$currentDate should throw error for invalid $type value', async () => {
      ...
      await assert.rejects(
        ...
        (err: Error) => {
          return (
            err.message.includes('required to be') || err.message.includes("'date' or 'timestamp'")
          );
        }
      );
    });
    ...
    it('$mul should throw error for null field value', async () => {
      ...
      await assert.rejects(
        async () => await collection.updateOne({ name: 'Alice' }, { $mul: { value: 2 } }),
        (err: Error) => {
          return err.message.includes('non-numeric') || err.message.includes('Cannot apply $mul');
        }
      );
    });
    ...
    it('$min should handle null current value using BSON ordering', async () => {
      ...
      const result = await collection.updateOne({ name: 'Alice' }, { $min: { value: 100 } });
    ...
    it('$min/$max should compare strings correctly', async () => {
      ...
      await collection.updateOne({ name: 'Alice' }, { $min: { code: 'alpha' } });

      let doc = await collection.findOne({ name: 'Alice' });
      assert.strictEqual(doc?.code, 'alpha');

      await collection.updateOne({ name: 'Alice' }, { $max: { code: 'gamma' } });
  ...
  describe('$push array modifiers', () => {
    describe('$position modifier', () => {
      it('should insert at specified position', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: ['x', 'y'], $position: 1 } } });
      ...
      it('should insert at beginning with position 0', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [0], $position: 0 } } });
      ...
      it('should handle negative position (from end)', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: ['x'], $position: -1 } } });
      ...
      it('should append if position exceeds array length', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [3], $position: 100 } } });
    ...
    describe('$slice modifier', () => {
      it('should keep first N elements with positive slice', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [4, 5, 6], $slice: 4 } } });
      ...
      it('should keep last N elements with negative slice', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [4, 5, 6], $slice: -3 } } });
      ...
      it('should remove all elements with slice 0', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [4, 5], $slice: 0 } } });
      ...
      it('should not truncate if slice exceeds array length', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [3], $slice: 10 } } });
    ...
    describe('$sort modifier', () => {
      it('should sort array ascending with $sort: 1', async () => {
        ...
        await collection.updateOne({}, { $push: { items: { $each: [5, 4], $sort: 1 } } });

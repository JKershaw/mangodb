...
describe(`Date Operators Extended (${getTestModeName()})`, () => {
  ...
  describe('$dateAdd', () => {
    it('should add days to date', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-06-20T00:00:00.000Z');
    });
    ...
    it('should add months to date', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-08-15T00:00:00.000Z');
    });
    ...
    it('should add years to date', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2024-06-15T00:00:00.000Z');
    });
    ...
    it('should add hours to date', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-06-15T13:00:00.000Z');
    });
    ...
    it('should add minutes to date', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-06-15T10:45:00.000Z');
    });
    ...
    it('should handle negative amounts (subtract)', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-06-10T00:00:00.000Z');
    });
  ...
  describe('$dateSubtract', () => {
    ...
    it('should subtract months from date', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-04-15T00:00:00.000Z');
    });
  ...
  describe('$dateFromParts', () => {
    it('should construct date from parts', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-06-15T14:30:45.000Z');
    });
    ...
    it('should use default values for optional parts', async () => {
      ...
      assert.strictEqual((results[0].result as Date).toISOString(), '2023-06-15T00:00:00.000Z');
    });

  ...
  describe('$type Operator', () => {
    describe('Basic Type Matching', () => {
      it('should match string type', async () => {
        ...
        await collection.insertMany([{ value: 'hello' }, { value: 123 }, { value: true }]);
      ...
      it('should match double type', async () => {
        ...
        await collection.insertMany([{ value: 3.14 }, { value: 42 }, { value: '3.14' }]);
      ...
      it('should match int type (integers only)', async () => {
        ...
        await collection.insertMany([{ value: 42 }, { value: 3.14 }, { value: -10 }]);
      ...
      it('should match objectId type', async () => {
        ...
        await collection.insertMany([{ value: 'not an id' }, { value: 12345 }]);
    ...
    describe('Numeric Type Codes', () => {
      it('should match using numeric code 2 (string)', async () => {
        ...
        await collection.insertMany([{ value: 'hello' }, { value: 123 }]);
      ...
      it('should match using numeric code 1 (double)', async () => {
        ...
        await collection.insertMany([{ value: 3.14 }, { value: 'string' }]);
      ...
      it('should match using numeric code 4 (array)', async () => {
        ...
        await collection.insertMany([{ value: [1, 2, 3] }, { value: 'not array' }]);
      ...
      it('should match using numeric code 8 (bool)', async () => {
        ...
        await collection.insertMany([{ value: true }, { value: 'true' }]);
    ...
    describe('Multiple Types', () => {
      ...
      it('should match string or null', async () => {
        ...
        await collection.insertMany([{ value: 'hello' }, { value: null }, { value: 123 }]);
      ...
      it('should match number or string using mixed codes', async () => {
        ...
        await collection.insertMany([{ value: 'hello' }, { value: 42 }, { value: true }]);
    ...
    describe('Edge Cases', () => {
      it('should not match missing fields for any type', async () => {
        ...
        await collection.insertMany([{ value: 'exists' }, { other: 'no value field' }]);
      ...
      it('should not match missing fields for null type', async () => {
        ...
        await collection.insertMany([{ value: null }, { other: 'no value field' }]);
  ...
  describe('$mod Operator', () => {
    describe('Basic Modulo Matching', () => {
      ...
      it('should find values with specific remainder', async () => {
        ...
        await collection.insertMany([{ value: 7 }, { value: 12 }, { value: 17 }, { value: 20 }]);
    ...
    describe('Edge Cases', () => {
      it('should not match non-numeric fields', async () => {
        ...
        await collection.insertMany([{ value: '4' }, { value: 4 }, { value: true }]);
      ...
      it('should not match null values', async () => {
        ...
        await collection.insertMany([{ value: null }, { value: 4 }]);
      ...
      it('should not match missing fields', async () => {
        ...
        await collection.insertMany([{ other: 'field' }, { value: 4 }]);
      ...
      it('should not match NaN document values', async () => {
        ...
        await collection.insertMany([{ value: NaN }, { value: 4 }]);
      ...
      it('should not match Infinity document values', async () => {
        ...
        await collection.insertMany([{ value: Infinity }, { value: -Infinity }, { value: 6 }]);
      ...
      it('should handle floating point divisor (truncation)', async () => {
        ...
        await collection.insertMany([{ value: 4 }, { value: 5 }, { value: 6 }]);
      ...
      it('should handle negative divisor', async () => {
        ...
        await collection.insertMany([{ value: 6 }, { value: 7 }, { value: 9 }]);
  ...
  describe('$expr Operator', () => {
    ...
    describe('Field to Constant Comparisons', () => {
      it('should compare field to constant number', async () => {
        ...
        await collection.insertMany([{ score: 85 }, { score: 95 }, { score: 75 }]);
    ...
    describe('Edge Cases', () => {
      ...
      it('should handle boolean result directly', async () => {
        ...
        await collection.insertMany([{ active: true }, { active: false }, { active: 1 }]);

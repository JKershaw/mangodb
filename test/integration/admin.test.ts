...
describe(`Administrative Operations Tests (${getTestModeName()})`, () => {
  ...
  describe('distinct', () => {
    ...
    it('should include null as a distinct value', async () => {
      ...
      await collection.insertMany([{ status: 'active' }, { status: null }, { status: 'inactive' }]);
    ...
    it('should handle mixed types', async () => {
      ...
      await collection.insertMany([{ value: 1 }, { value: '1' }, { value: 1 }, { value: true }]);
